...
roof.position.y = 2.5+0.5 //paredes tienen altura de 2.5 y la altura del techo es de 1
...
for(let i = 0; i<50; i++){
    const angle = Math.random()*Math.PI*2 // angulo aleatorio
    const radius = 3 + Math.random() * 6 // radio aleatorio
    ...
    //Se añade la tumba al contenedor
    graves.add(grave)
}
